...
// 3. Get Available Exams for Class
const getExamsByClass = async (req, res) => {
  const classLevel = normalizeClassLevel(req.params.classLevel);
...
// 4. Get Questions for Specific Exam ID
...
// 5. Submit Exam Answers (Auto-Grade + Single Attempt Limit)
